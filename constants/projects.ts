...
export const projects: ProjectItem[] = [
  {
    ...
    tags: ["Next.js", "React Native", "TypeScript", "PostgreSQL", "Tailwind CSS", "Expo"],
    description: {
      lead: "Soldbay — an end-to-end commerce platform designed for student and community trade with verified buyer-seller protection and logistics coordination.",
      paragraphs: [
        ...
        "Vendors manage inventory listings, process instant checkouts, and track real-time fulfillment across web and mobile.",
      ],
    },
  ...
  },
  {
    ...
    tags: ["React", "React Native", "Go", "TypeScript", "PostgreSQL", "REST APIs"],
    description: {
      paragraphs: [
  ...
  },
  {
    ...
    description: {
      ...
      footer: "Engineered for zero downtime and effortless daily retail bookkeeping.",
    },
